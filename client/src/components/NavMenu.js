...
const NavMenu = () => {
    ...
    return (
        <Navbar bg="dark" variant="dark" expand="lg">
            <Container className="fluid px-4">
                <Navbar.Brand href="/dashboard" className="pe-5"><FontAwesomeIcon icon={faShoppingCart}/></Navbar.Brand>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        <Button className="my-3 mx-5" onClick={onClick} >Logout</Button>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
